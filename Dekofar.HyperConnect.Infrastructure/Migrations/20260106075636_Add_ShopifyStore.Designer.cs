...
namespace Dekofar.HyperConnect.Infrastructure.Migrations
{
    ...
    [Migration("20260106075636_Add_ShopifyStore")]
    partial class Add_ShopifyStore
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.ActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.AllowedAdminIp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.BlacklistEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.DeploymentLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.ModerationRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.PinCoverImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<TimeSpan?>("DisplayEndTime")
                        .HasColumnType("interval");

                    b.Property<TimeSpan?>("DisplayStartTime")
                        .HasColumnType("interval");
                    ...
                    b.ToTable("PinCoverImages");
                });

            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.ResponseTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.ShopifyStore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.ShopifyWebhookEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Topic", "ExternalId");

                    b.ToTable("ShopifyWebhookEvents", (string)null);
                });
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.UserBadge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.UserUIPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.WorkSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.Order", b =>
                {
                    b.HasOne("Dekofar.HyperConnect.Domain.Entities.ApplicationUser", "Customer")
                        .WithMany()
